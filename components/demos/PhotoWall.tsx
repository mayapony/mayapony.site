import "@/styles/photo-wall.scss";

/* eslint-disable @next/next/no-img-element */
function PhotoWall() {
  return (
    <div className="relative h-72 grow overflow-hidden rounded-lg bg-ctp-crust">
        ...
        <ul>
          <li>
            <img
              ...
              alt="A Toyota covered in graffiti"
              loading="lazy"
            />
          </li>
          <li>
          ...
          <li>
            <img
              ...
              alt="crossing the street on a bike"
              loading="lazy"
            />
          </li>
          <li>
          ...
          <li>
            <img
              ...
              alt="Tom and wearing sunglasses"
              loading="lazy"
            />
          </li>
          <li>
          ...
          <li>
            <img
              ...
              alt="Window reflection of me and P"
              loading="lazy"
            />
          </li>
          <li>
          ...
          <li>
            <img
              ...
              alt="riding a bike with no hands"
              loading="lazy"
            />
          </li>
          <li>
